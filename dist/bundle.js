...
/***/ function(module, exports, __webpack_require__) {
	...
	window.TagDataParser = __webpack_require__(1);
	...
	module.exports = (function() {
	  ...
	  function parse(input) {
	    var options = arguments.length > 1 ? arguments[1] : {},
	        ...
	        peg$c0 = null,
	        peg$c1 = { type: "other", description: "tag data" },
	        peg$c2 = peg$FAILED,
	        peg$c3 = [],
	        ...
	        peg$c13 = function(char) {
	            var expr = char == '"' ? "'\"'" : '"' + char + '"';
	            error("Tag name includes illegal character: " + expr);
	          },
	        peg$c14 = /^[^: ]/,
	    ...
	    function peg$parseTagData() {
	      var s0, s1, s2, s3, s4, s5;

	      peg$silentFails++;
	      s0 = peg$currPos;
	      s1 = peg$parseTagDatum();
	      if (s1 !== peg$FAILED) {
	        s2 = [];
	        s3 = peg$currPos;
	        s4 = peg$currPos;
	        s5 = peg$parseTagSeparater();
	        if (s5 !== peg$FAILED) {
	          s5 = input.substring(s4, peg$currPos);
	        }
	        s4 = s5;
	        if (s4 !== peg$FAILED) {
	          s5 = peg$parseTagDatum();
	          if (s5 !== peg$FAILED) {
	            s4 = [s4, s5];
	            s3 = s4;
	          } else {
	    ...
	    function peg$parseTagSeparater() {
	      var s0, s1;
	    ...
	    function peg$parseVersionSeparater() {
	      var s0;
